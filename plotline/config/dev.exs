...
config :plotline, PlotlineWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "PrhAUVd5fYQoEBGANA0HqYLV6UsbRJSSRSlfXv6Xw5lg0IoimgvLNtBPElLiI20T",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:plotline, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:plotline, ~w(--watch)]}
  ]
...
config :plotline, PlotlineWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/plotline_web/router\.ex$",
      ~r"lib/plotline_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :plotline, dev_routes: true
